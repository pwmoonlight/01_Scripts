...
write.csv(obs.beta.sim, file=paste("05_Wombling_Null_Models/03_Null_Beta_Diversity/", brick, "/sim.csv", sep=""))
write.csv(obs.beta.sor, file=paste("05_Wombling_Null_Models/03_Null_Beta_Diversity/", brick, "/sor.csv", sep=""))
