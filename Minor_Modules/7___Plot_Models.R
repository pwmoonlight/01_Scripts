...
for(x in 1:length(species)){
  ...
  species.data <- read.csv(paste("09_Species_To_Model_Scale_Corrected_Distribution_Data/", species[[x]], ".csv", sep=""))[,-1]
  
  png(filename=paste("11_models/Plots/", species[[x]], ".png"), width=8126, height=8126, units="px")
