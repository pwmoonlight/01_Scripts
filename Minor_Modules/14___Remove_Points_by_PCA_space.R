...
for(x in 1:length(species)){
  if(!dir.exists(paste("03_Modelling/04_Species_To_Model_Distribution_Data/Cleaned_6/", species[[x]], sep=""))){
    dir.create(paste("03_Modelling/04_Species_To_Model_Distribution_Data/Cleaned_6/", species[[x]], sep=""), showWarnings = F)
